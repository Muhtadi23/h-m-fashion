...
const ProductCard = ({ image, image2 }) => {
    return (
        <div className="group relative w-full max-w-[320px] sm:max-w-[340px] md:max-w-[360px] lg:max-w-[380px] xl:max-w-[400px] mx-auto">
            ...
            {/* Shadow */}
            <div className="absolute inset-0 rounded-3xl bg-gray-200 -z-10 transform scale-95 opacity-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500" />
        </div>
    );
};
